...
namespace PixelPhoto.Activities.AddPost.Adapters
{
    ...
    {
        public GifAdapterViewHolder(View itemView, Action<GifAdapterClickEventArgs> clickListener,
            Action<GifAdapterClickEventArgs> longClickListener) : base(itemView)
        {
            try
            {
                MainView = itemView;
                ...
                //Create an Event
                itemView.Click += (sender, e) => clickListener(new GifAdapterClickEventArgs
