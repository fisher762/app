...
namespace PixelPhoto.Activities.Editor.Tools
{
    public class TextEditorFragment : DialogFragment, ITextEditor
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            return inflater.Inflate(Resource.Layout.AddTextDialog, container, false);
        }
        ...
        public TextEditorFragment Show(Activity contextActivity, ViewTextType type)
        {
            try
            {
                return Show(contextActivity, ImageActivity, EditColorActivity, "", Resource.Color.white, type);
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
