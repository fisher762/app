...
namespace PixelPhoto.Activities.SettingsUser.Privacy
{
    ...
    public class SettingPrivacyActivity : BaseActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                SupportFragmentManager.BeginTransaction().Replace(Resource.Id.content_frame, new SettingPrivacyPrefcFragment(this)).Commit();
            }
            catch (Exception e)
            {
