...
namespace PixelPhoto.Helpers.Controller
{
    public class IntentController
    {
        ...
        private File CreateImageFile()
        {
            ...
            var storageDir = Methods.Path.FolderDcimImage;

            try
            {
                var image = File.CreateTempFile(imageFileName, ".jpg", new File(storageDir));
            ...
            {
                Methods.DisplayReportResultTrack(e);
                var image = new File(storageDir + "/" + imageFileName, ".jpg");
                // Save a file: path for use with ACTION_VIEW intents
                CurrentPhotoPath = image.AbsolutePath;
                return image;
            }
        ...
        private File CreateVideoFile()
        {
            // Create an image file name
            var timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").Format(new Date());
            var videoFileName = "Video_" + timeStamp + "_";
            var storageDir = Methods.Path.FolderDcimVideo;

            var video = new File(storageDir + "/" + videoFileName + ".mp4");
        ...
        public void OpenFacebookIntent(Context context, string name)
        {
            try
            {
                var facebookIntent = GetOpenFacebookIntent(context, name);
        ...
        public void OpenLinkedInIntent(string name)
        {
            try
            {
                var url = "https://www.linkedin.com/in/" + name;
                var linkedInAppIntent = new Intent(Intent.ActionView, Uri.Parse(url));
        ...
        public void OpenInstagramIntent(string name)
        {
            try
            {
                var likeIng = new Intent(Intent.ActionView, Uri.Parse("http://instagram.com/_u/" + name));
        ...
        public void OpenYoutubeIntent(string channelId)
        {
            try
            {
                var likeIng = new Intent(Intent.ActionView, Uri.Parse("vnd.youtube://user/channel/" + channelId));
        ...
        public void OpenVkontakteIntent(string friendId)
        {
            try
            {
                var likeIng = new Intent(Intent.ActionView, Uri.Parse("vkontakte://profile/%d" + friendId));
        ...
        public void OpenTelegramIntent(string friendId)
        {
            try
            {
                var likeIng = new Intent(Intent.ActionView, Uri.Parse("tg://resolve?domain=" + friendId));
