...
namespace PixelPhoto.Library.Anjo.StoriesProgressView
{
    public class StoriesProgressView : LinearLayout
    {
        ...
        private void Init(Context context, IAttributeSet attrs)
        {
            ...
            if (attrs != null)
            {
                var typedArray = context.ObtainStyledAttributes(attrs, Resource.Styleable.StoriesProgressView);
        ...
        {
            var p = new PausableProgressBar(Context) {LayoutParameters = ProgressBarLayoutParam};
            return p;
        }

        private View CreateSpace()
        {
            var v = new View(Context) {LayoutParameters = SpaceLayoutParam};
            return v;
        }
        ...
        private class MyPassableProgressBar : PausableProgressBar.ICallback
        {
            ...
            public void OnFinishProgress()
            {
                if (ProgressView.IsReverseStart)
                {
                    ...
                    {
                        var p = ProgressView.ProgressBars[ProgressView.Current - 1];
                ...
                var next = ProgressView.Current + 1;
