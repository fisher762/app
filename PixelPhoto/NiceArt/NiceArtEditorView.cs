    ...
    public class NiceArtEditorView : RelativeLayout, INiceArt.IOnSaveBitmap, INiceArt.IOnImageChangedListener
    {
        ...
        public void Init(Context context, IAttributeSet attrs)
        {
            try
            {
                ...
                var imgSrcParam = new LayoutParams(ViewGroup.LayoutParams.MatchParent, ViewGroup.LayoutParams.WrapContent);
                ...
                var brushParam = new LayoutParams(ViewGroup.LayoutParams.MatchParent, ViewGroup.LayoutParams.WrapContent);
                ...
                //Align brush to the size of image view
                var imgFilterParam = new LayoutParams(ViewGroup.LayoutParams.MatchParent, ViewGroup.LayoutParams.WrapContent);
