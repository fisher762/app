    ...
    public class ScaleGestureDetector
    {
                        ...
                        case MotionEventActions.PointerDown:
                            {
                                ...
                                var oldActive0 = MActiveId0;
                                var oldActive1 = MActiveId1;
                                Reset();
                        ...
                        case MotionEventActions.PointerUp:
                            {
                                ...
                                if (pointerCount > 2)
                                {
                                    ...
                                    {
                                        var newIndex = FindNewActiveIndex(Event, MActiveId1, actionIndex);
                                        if (newIndex >= 0)
                                        {
                                            MListener.OnScaleEnd(view, this);
                                    ...
                                    {
                                        var newIndex = FindNewActiveIndex(Event, MActiveId0, actionIndex);
                                        if (newIndex >= 0)
                                        {
                                            MListener.OnScaleEnd(view, this);
                                ...
                                if (gestureEnded)
                                {
                                    ...
                                    var activeId = actionId == MActiveId0 ? MActiveId1 : MActiveId0;
                                    var index = Event.FindPointerIndex(activeId);
                        ...
                        case MotionEventActions.Move:
                            {
                                ...
                                {
                                    var updatePrevious = MListener.OnScale(view, this);
        ...
        public int FindNewActiveIndex(MotionEvent ev, int otherActiveId, int removedPointerIndex)
        {
            try
            {
                ...
                var otherActiveIndex = ev.FindPointerIndex(otherActiveId);
        ...
        public void SetContext(View view, MotionEvent curr)
        {
            try
            {
                ...
                var prevIndex0 = prev.FindPointerIndex(MActiveId0);
                var prevIndex1 = prev.FindPointerIndex(MActiveId1);
                var currIndex0 = curr.FindPointerIndex(MActiveId0);
                var currIndex1 = curr.FindPointerIndex(MActiveId1);
                ...
                var px0 = prev.GetX(prevIndex0);
                var py0 = prev.GetY(prevIndex0);
                var px1 = prev.GetX(prevIndex1);
                var py1 = prev.GetY(prevIndex1);
                var cx0 = curr.GetX(currIndex0);
                var cy0 = curr.GetY(currIndex0);
                var cx1 = curr.GetX(currIndex1);
                var cy1 = curr.GetY(currIndex1);
        ...
        public float GetCurrentSpan()
        {
            try
            {
                if (MCurrLen == -1)
                {
                    var cvx = MCurrFingerDiffX;
                    var cvy = MCurrFingerDiffY;
        ...
        public float GetPreviousSpan()
        {
            try
            {
                if (MPrevLen == -1)
                {
                    var pvx = MPrevFingerDiffX;
                    var pvy = MPrevFingerDiffY;
