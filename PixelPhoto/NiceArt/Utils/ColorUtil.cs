...
namespace PixelPhoto.NiceArt.Utils
{
    public class ColorUtil
    {
        ...
        public static int HexStringToInt(string str)
        {
            ...
            var intValue = int.Parse(str, System.Globalization.NumberStyles.HexNumber);
        ...
        public static int MixTwoColors(int color1, int color2, float amount)
        {
            ...
            var inverseAmount = 1.0f - amount;

            var a = (int)((color1 >> alphaChannel & 0xff) * amount + (color2 >> alphaChannel & 0xff) * inverseAmount) & 0xff;
            var r = (int)((color1 >> redChannel & 0xff) * amount + (color2 >> redChannel & 0xff) * inverseAmount) & 0xff;
            var g = (int)((color1 >> greenChannel & 0xff) * amount + (color2 >> greenChannel & 0xff) * inverseAmount) & 0xff;
            var b = (int)((color1 & 0xff) * amount + (color2 & 0xff) * inverseAmount) & 0xff;
